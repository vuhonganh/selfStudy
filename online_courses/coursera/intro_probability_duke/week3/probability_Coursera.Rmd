...
Answer is E. The shortest streak is of length 1. This is false because there is length 0. 
Otherwises, we can check all the other information by calling:
```{r summary-streak-kobe}
...
Answer is A: quite similar, even Bryan 'streak is worse than sim_streak.
